...
<h2 class="text-center"> Sign into the Pals Portal </h2>
  ...
  <form>
    ...
    <button type="submit" class="btn btn-primary centerBtnForm">Submit</button>
  </form>

  


  <h2 class="text-center"><a href="PALS"> PALS DIRECTORY TEST</a> </h2>

  <h3 class="text-center"> Past projects and publications about Pals.. </h3>
